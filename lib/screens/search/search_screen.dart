...
import 'package:ticket_app_final/screens/search/widgets/app_text_icon.dart';
import 'package:ticket_app_final/screens/search/widgets/app_ticket_tabs.dart';
import 'package:ticket_app_final/screens/search/widgets/find_tickets.dart';
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          Text("Bạn đang tìm kiếm gì?", style: AppStyles.headLineStyle1.copyWith(fontSize: 35),),
